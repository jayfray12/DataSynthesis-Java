...
public class DataexistingZipcodeintlEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "Country", referencedColumnName = "CountryID", table = "dataexisting_zipcodeintl")
    ...
    @ManyToOne
    @JoinColumn(name = "StatusID", referencedColumnName = "StatusID", table = "dataexisting_zipcodeintl")
