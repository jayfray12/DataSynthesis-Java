...
public class DatageneratedAddressesEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "StatusID", referencedColumnName = "StatusID", table = "datagenerated_addresses")
    ...
    @ManyToOne
    @JoinColumn(name = "AddressFormatTypeId", referencedColumnName = "AddressFormatTypeID", table = "datagenerated_addresses")
