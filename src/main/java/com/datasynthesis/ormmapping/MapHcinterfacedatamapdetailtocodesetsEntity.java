...
@Table(name = "map_hcinterfacedatamapdetailtocodesets", schema = "datasynthesis", catalog = "")
public class MapHcinterfacedatamapdetailtocodesetsEntity {
    ...
    @Id
    @Column(name = "HCInterfaceDataMapToCodesetsDataMappingDetailID", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "StatusID", referencedColumnName = "StatusID", table = "map_hcinterfacedatamapdetailtocodesets")
