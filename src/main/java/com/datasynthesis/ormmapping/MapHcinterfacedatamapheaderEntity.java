...
@Table(name = "map_hcinterfacedatamapheader", schema = "datasynthesis", catalog = "")
public class MapHcinterfacedatamapheaderEntity {
    ...
    @Id
    @Column(name = "HCInterfaceDataMapHeaderID", nullable = false)
    ...
    @Basic
    @Column(name = "InterfaceName", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "InterfaceDesc", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "MessageType", nullable = true, length = 11)
    ...
    @Basic
    @Column(name = "MessageTrigger", nullable = true, length = 10)
    ...
    @Basic
    @Column(name = "MessageVersion", nullable = true, length = 7)
    ...
    @Basic
    @Column(name = "HCInterfaceDataMapHeaderGUID", nullable = true, length = 38)
    ...
    @ManyToOne
    @JoinColumn(name = "StatusID", referencedColumnName = "StatusID", table = "map_hcinterfacedatamapheader")
